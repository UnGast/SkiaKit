...
public final class Path {
     ...
     */
    @discardableResult
    public func addRect (_ rect: Rect, direction: Direction = .clockwise, start: Int32) -> Path
    {
        var r = rect
        sk_path_add_rect_start(handle, &r, direction.toNative(), UInt32(start))
        return self
    }
     ...
     */
    @discardableResult
    public func addRoundedRect (_ roundedRect: RoundRect, direction: Direction = .clockwise, start: Int32) -> Path
    {
        sk_path_add_rrect_start(handle, roundedRect.handle, direction.toNative(), UInt32(start))
        return self
    }
